...
export default function Home() {
  return (
    <main className="tw-flex tw-min-h-screen tw-flex-col tw-items-center tw-justify-between tw-p-24">
      <div className="tw-z-10 tw-w-full tw-max-w-5xl items-center justify-between tw-font-mono tw-text-sm lg:tw-flex">
        <p className="tw-fixed tw-left-0 tw-top-0 tw-flex tw-w-full tw-justify-center tw-border-b tw-border-gray-300 tw-bg-gradient-to-b tw-from-zinc-200 tw-pb-6 tw-pt-8 tw-backdrop-blur-2xl dark:tw-border-neutral-800 dark:tw-bg-zinc-800/30 dark:tw-from-inherit lg:tw-static lg:tw-w-auto  lg:tw-rounded-xl lg:tw-border lg:tw-bg-gray-200 lg:tw-p-4 lg:dark:tw-bg-zinc-800/30">
          ...
          <code className="tw-font-mono tw-font-bold">app/page.tsx</code>
        </p>
        <div className="tw-fixed tw-bottom-0 tw-left-0 tw-flex tw-h-48 tw-w-full tw-items-end tw-justify-center tw-bg-gradient-to-t tw-from-white tw-via-white dark:tw-from-black dark:tw-via-black lg:tw-static lg:tw-size-auto lg:tw-bg-none">
          <a
      ...
      <div className="tw-relative tw-z-[-1] tw-flex tw-place-items-center before:tw-absolute before:tw-h-[300px] before:tw-w-full before:tw--translate-x-1/2 before:tw-rounded-full before:tw-bg-gradient-radial before:tw-from-white before:tw-to-transparent before:tw-blur-2xl before:tw-content-[''] after:tw-absolute after:tw--z-20 after:tw-h-[180px] after:tw-w-full after:tw-translate-x-1/3 after:tw-bg-gradient-conic after:tw-from-sky-200 after:tw-via-blue-200 after:tw-blur-2xl after:tw-content-[''] before:dark:tw-bg-gradient-to-br before:dark:tw-from-transparent before:dark:tw-to-blue-700 before:dark:tw-opacity-10 after:dark:tw-from-sky-900 after:dark:tw-via-[#0141ff] after:dark:tw-opacity-40 sm:before:w-[480px] sm:after:w-[240px] before:lg:tw-h-[360px]">
        <Image
      ...
      <div className="tw-mb-32 tw-grid tw-text-center lg:tw-mb-0 lg:tw-w-full lg:tw-max-w-5xl lg:tw-grid-cols-4 lg:tw-text-left">
        <a
        ...
        >
          ...
          <p className="tw-m-0 tw-max-w-[30ch] tw-text-balance tw-text-sm tw-opacity-50">
